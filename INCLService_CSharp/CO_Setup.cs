// <summary>
// CO_Setup.cs - C# translation of CO_Setup.pas
// Compatibility wrapper for CO_Setup2
// </summary>

namespace INCLService_CSharp
{
    /// <summary>
    /// CO_Setup class - compatibility wrapper for CO_Setup2
    /// Note: New parameters should only be added via CO_Setup2!
    /// CO_Setup is only for compatibility with old source code.
    /// </summary>
    public static class CO_Setup
    {
        // Parameter name constants (for compatibility)
        ...
        /// <summary>
        /// Get parameter as integer (deprecated - use CO_Setup2.GetParamInt)
        /// </summary>
        public static int GetParamInt_to_delete_(CO_Query Q, string Par)
        {
            return CO_Setup2.TCO_Setup.GetParamInt(Q, Par);
        }

        /// <summary>
        /// Get parameter as string (deprecated - use CO_Setup2.GetParamStr)
        /// </summary>
        public static string GetParamStr_to_delete_(CO_Query Q, string Par)
        {
            return CO_Setup2.TCO_Setup.GetParamStr(Q, Par);
        }

        /// <summary>
        /// Get parameter as boolean (deprecated - use CO_Setup2.GetParamBool)
        /// </summary>
        public static bool GetParamBool_to_delete_(CO_Query Q, string Par)
        {
            return CO_Setup2.TCO_Setup.GetParamBool(Q, Par);
        }
    }
}
