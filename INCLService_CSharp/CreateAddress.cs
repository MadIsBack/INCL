// <summary>
// CreateAddress.cs - C# translation of CreateAddress.pas
// SPS address definitions for order reset
// </summary>
...
{
    /// <summary>
    /// Order reset address structure
    /// </summary>
    public class TAuftragReset
    {
        public string Produziert { get; set; } = string.Empty;
        public string Geprueft { get; set; } = string.Empty;
        public string Verpackt { get; set; } = string.Empty;
    }

    /// <summary>
    /// CreateAddress class - contains SPS address definitions
    /// </summary>
    public static class CreateAddress
    {
        // Global markers
        public static string MerkerSchichtwechsel { get; set; } = "M2.1";
        public static string MerkerRoteLampe { get; set; } = "A28.6";

        // Order reset addresses for each machine (1-32)
        public static TAuftragReset[] AuftragReset { get; private set; } = new TAuftragReset[33]; // 1-based indexing

        /// <summary>
        /// Initialize address definitions
        /// </summary>
        public static void InitAddr()
        {
            // Initialize all reset addresses
            for (int i = 1; i <= 32; i++)
            {
                AuftragReset[i] = new TAuftragReset();
            }

            // Produzierte Artikel / StueckGesamt / Reset
        ...
        /// <summary>
        /// Static constructor to initialize addresses
        /// </summary>
